...
import { Stethoscope, Plus, Image, User, Menu, X } from "lucide-react";
    ...
    >
      ...
      <div className="flex flex-col h-full">
              ...
              <div className="space-y-1 pb-4">
                {chatHistory.map((chat) => (
                  <motion.button
                    ...
                    className={`w-full text-left px-3 py-2 rounded-xl hover:bg-[#F9FBFC] transition-colors text-[#333333] text-sm cursor-pointer ${
                      currentChatId === chat.id ? 'bg-[#F9FBFC] border-l-2 border-[#4BA3C3]' : ''
                    }`}
                  >
                    {chat.title}
                  </motion.button>
        ...
        <button
          ...
          className={`p-4 flex items-center gap-3 hover:bg-[#F9FBFC] transition-colors cursor-pointer ${
        ...
        >
          ...
          {isExpanded && (
            ...
            >
              <span className="text-sm text-[#333333]">Rumaan Zameer</span>
